class IssuesController < ApplicationController
  ...
  def create
    @user = Issue.find(current_user.id)
  ...
  def update
    respond_to do |format|
      if @issue.update(issue_params)
        format.html { redirect_to root_url(@issue), notice: 'Issue was successfully updated.' }
  ...
  def destroy
    ...
    respond_to do |format|
      format.html { redirect_to root_url, notice: 'Issue was successfully destroyed.' }
  ...
  def issue_params
    params.require(:issue).permit(:title, :notes, :status)
  end
end
